...
public class Modelo {
	 ...
	 * @param tipoBarra tipo das barras do modelo estrutural (viga, pórtico ou
	 *                  treliça)
	 */
	...
	/**
	 * Método de acesso Get que retorna o nó na posição específica (i) dentro da
	 * lista de nós (listaNode [i]).
	 * 
	...
	/**
	 * Método de acesso Get que retorna o material em uma posição específica (i)
	 * dentro da lista de materiais (listaMaterial [i]).
	 * 
	...
	public Material getMaterial(int i) {
		if ((i >= 0) && (i < this.get_numeroDeMateriais()))
			...
			System.out
					.println("Método get incorreto: Tentativa de acesso em posição inexistente da lista de materiais");
			System.exit(1);
			return null;
		}
	}
	...
	/**
	 * Método de acesso Get que retorna a seção transversal em uma posição
	 * específica (i) dentro da lista de seções transversais (listaSecao [i]).
	 * 
	 * @param i posição específica dentro da lista de seções transversais
	 * @return seção transversal em uma posição específica dentro da lista de seções
	 *         transversais
	 */
	public SecaoTransversal getSecao(int i) {
		if ((i >= 0) && (i < this.get_numeroDeSecoes()))
			...
			System.out.println(
					"Método get incorreto: Tentativa de acesso em posição inexistente da lista de seções transversais");
			System.exit(1);
			return null;
		}
	}
	...
	/**
	 * Método de acesso Get que retorna a barra em uma posição específica (i) dentro
	 * da lista de barras (listaBarra [i]).
	 * 
	...
	/**
	 * Método de acesso Get que retorna o nó na posição do identificador do nó (id)
	 * dentro da lista de nós (listaNode [id]).
	 * 
	...
	/**
	 * Método de acesso Get que retorna o material na posição do identificador do
	 * material (id) dentro da lista de materiais (listaMaterial [id]).
	 * 
	 * @param id identificador do material dentro da lista de material
	 * @return material na posição do identificador do material dentro da lista de
	 *         material
	 */
	...
	/**
	 * Método de acesso Get que retorna a seção transversal na posição do
	 * identificador da seção transversal (id) dentro da lista de seções
	 * transversais (listaSecao [id]).
	 * 
	 * @param id identificador da seção transversal dentro da lista de seções
	 *           transversais
	 * @return seção transversal na posição do identificador da seção transversal
	 *         dentro da lista de seções transversais
	 */
	...
	/**
	 * Método de acesso Get que retorna a barra na posição do identificador da barra
	 * (id) dentro da lista de barras (listaBarra [id]).
	 * 
	...
	/**
	 * Método modificador Set da lista de nós que compõem o modelo estrutural
	 * (listaNode) (sem retorno).
	 * 
	...
	/**
	 * Método modificador Set da lista de materiais que compõem o modelo estrutural
	 * (listaMaterial) (sem retorno).
	 * 
	...
	/**
	 * Método modificador Set da lista de seções transversais que compõem o modelo
	 * estrutural (listaSecao) (sem retorno).
	 * 
	 * @param listaSecao lista de seções transversais que compõem o modelo
	 *                   estrutural
	 */
	...
	/**
	 * Método modificador Set da lista de barras que compõem o modelo estrutural
	 * (listaBarra) (sem retorno).
	 * 
	...
	/**
	 * Método modificador Set em uma posição específica (i) da lista de nós que
	 * compõem o modelo estrutural (listaNode [i]) (sem retorno).
	 * 
	 * @param i    posição específica dentro da lista de nós
	...
	public void setMaterial(int i, Material mat) {
		if ((i >= 0) && (i < this.get_numeroDeMateriais()))
			...
			System.out.println(
					"Método set incorreto: Tentativa de modificação de posição inexistente da lista de materiais");
			System.exit(1);
		}
	}

	/**
	 * Método modificador Set em uma posição específica (i) da lista de seções
	 * transversais que compõem o modelo estrutural (listaSecao [i]) (sem retorno).
	 * 
	 * @param i   posição específica dentro da lista de seções transversais
	...
	public void setSecao(int i, SecaoTransversal sec) {
		if ((i >= 0) && (i < this.get_numeroDeSecoes()))
			...
			System.out.println(
					"Método set incorreto: Tentativa de modificação de posição inexistente da lista de seções");
			System.exit(1);
		}
	}

	/**
	 * Método modificador Set em uma posição específica (i) da lista de barras que
	 * compõem o modelo estrutural (listaBarra [i]) (sem retorno).
	 * 
	 * @param i   posição específica dentro da lista de barras
	...
	public void setBarra(int i, Barra bar) {
		if ((i >= 0) && (i < this.get_numeroDeBarras()))
			...
			System.out.println(
					"Método set incorreto: Tentativa de modificação de posição inexistente da lista de barras");
			System.exit(1);
		}
	}

	/**
	 * Método modificador Set na posição do identificador do nó (id) dentro da lista
	 * de nós que compõem o modelo estrutural (listaNode [i]) (sem retorno).
	 * 
	 * @param id identificador do nó dentro da lista de nós
	 ...
	 * lista de materiais que compõem o modelo estrutural (listaMaterial [i]) (sem
	 * retorno).
	 * 
	...
	/**
	 * Método modificador Set na posição do identificador da seção transversal (id)
	 * dentro da lista de seções transversais que compõem o modelo estrutural
	 * (listaSecao [i]) (sem retorno).
	 * 
	 * @param id  identificador da seção transversal dentro da lista de seções
	 *            transversais
	 * @param sec seção transversal modificada
	 ...
	 * lista de barras que compõem o modelo estrutural (listaBarra [i]) (sem
	 * retorno).
	 * 
	...
	/**
	 * Método que retorna o número de graus de liberdade do nó em função do tipo de
	 * barra.
	 * 
	...
	/**
	 * Método que retorna um booleano para verificar se o identificador do material
	 * (id) já foi utilizado anteriormente na lista de materiais.
	 * 
	 * @param id identificador do material dentro da lista de material
	 * @return verdadeiro quando já existe um material com o idenficador do material
	 *         fornecido, falso para o contrário
	 */
	...
	/**
	 * Método que retorna um booleano para verificar se o identificador da seção
	 * transversal (id) já foi utilizado anteriormente na lista de seções
	 * transversais.
	 * 
	 * @param id identificador da seção transversal dentro da lista de seções
	 *           transversais
	...
	/**
	 * Método que retorna um booleano para verificar se o identificador da barra
	 * (id) já foi utilizado anteriormente na lista de barras.
	 * 
	 * @param id identificador da barra dentro da lista de barras
	 * @return verdadeiro quando já existe uma barra com o idenficador da barra
	 *         fornecida, falso para o contrário
	 */
	...
	/**
	 * Método que retorna um texto contendo os dados do modelo: barras descritas por
	 * nós iniciais e finais associados a coordenadas x, y z materiais descritos
	 * pelo módulo de elasticidade e coeficiente de poisson seções descritas pela
	 * área e momento de inércia da seção transversal.
	 * 
