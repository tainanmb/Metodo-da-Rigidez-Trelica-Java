...
/**
 * Classe que descreve uma sessão transversal qualquer prescrita pelo usuário
 * <p>
 * Dados:
 * <ul>
...
public class SecaoTransversalPrescrita extends SecaoTransversalFac implements SecaoTransversal {
	...
	/**
	 * Construtor que recebe como argumento o identificador (id), a área (A) e a
	 * inércia da seção transversal (I) e preenche todos os campos da seção
	 * transversal.
	 * 
