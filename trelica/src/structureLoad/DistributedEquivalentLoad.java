...
/**
 * Interface que caracteriza o carregamento equivalente de uma carga distribuída
 * de uma barra. descreve os métodos necessários em classes cuja interface é
...
public interface DistributedEquivalentLoad extends EquivalentLoad {
	 ...
	 * iniciais e finais, oriundas de cargas distribuídas aplicadas ao longo da
	 * barra.
	 * 
	 * @return EquivalentLoadFromQ vetor com as forças equivalentes devido as cargas
	 *         Q
	 */
